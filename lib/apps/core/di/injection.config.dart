...
import 'package:doctor_hunt/apps/core/auth/auth_status_notifier.dart' as _i734;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i734.AuthStatusNotifier>(
      () => _i734.AuthStatusNotifier(gh<_i498.AuthRepository>()),
    );
