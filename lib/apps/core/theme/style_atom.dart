...
class StyleAtom {
  ...
  static TextStyle get appointmentTitle => TextStyle(
        fontSize: 18.sp,
        fontWeight: FontWeight.w700,
        color: AppColors.title,
        fontFamily: fontFamilyRubik,
  ...
  static TextStyle get thankYouTitle => TextStyle(
        fontSize: 30.sp,
        fontWeight: FontWeight.w700,
        color: AppColors.heading,
        fontFamily: fontFamilyPlusJakartaSans,
  ...
  static TextStyle get thankYouSubtitle => TextStyle(
        fontSize: 16.sp,
        fontWeight: FontWeight.w500,
        color: AppColors.primary,
        fontFamily: fontFamilyPlusJakartaSans,
  ...
  static TextStyle get thankYouBody => TextStyle(
        fontSize: 14.sp,
        height: 1.43,
        color: AppColors.secondary,
        fontFamily: fontFamilyPlusJakartaSans,
